"""
Step 1: Feature Screening for Two-Step Shrinkage GLM

This script fits the full high-dimensional Bayesian GLM to identify active spatial and calendar covariates.
It saves the selected feature indices for the subsequent refitting step.

To adapt this script for the Israel (ISR) panel:
1. Change `TRAIN_WEEKS_GLM` from 308 to 370.
2. Change the output directory from "glm_output_ukr" to "glm_output_isr".
"""
...
if __name__ == "__main__":
    index = sys.argv[1]
    print(index)
    # run_batch(int(index) - 1, "glm_output_isr")
    run_batch(int(index) - 1, "glm_output_ukr")